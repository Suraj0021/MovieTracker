...
import com.suraj.movietracker.databinding.FragmentUpcomingBinding
...
class UpcomingFragment : Fragment() {
    ...
    private fun setRefreshRV() {
        ...
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            movieViewModel.getUpcomingMoviesData(page)
    ...
    private fun setPagingInRV() {
        ...
        binding.rvUpcomingMoviesList.addOnScrollListener(object :
    ...
    private fun initData() {
        ...
        binding.rvUpcomingMoviesList.adapter = moviesAdapter
        binding.rvUpcomingMoviesList.layoutManager = GridLayoutManager(requireContext(), 2)
