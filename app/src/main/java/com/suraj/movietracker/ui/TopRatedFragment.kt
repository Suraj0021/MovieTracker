...
class TopRatedFragment : Fragment() {
    ...
    private fun setRefreshRV() {
        ...
        binding.swipeRefreshLayout.setOnRefreshListener {
            ...
            movieViewModel.getTopRatedMoviesData(page)
    ...
    private fun setPagingInRV() {
        ...
        binding.rvTopRatedMoviesList.addOnScrollListener(object :
    ...
    private fun initData() {
        ...
        binding.rvTopRatedMoviesList.adapter = moviesAdapter
        binding.rvTopRatedMoviesList.layoutManager = GridLayoutManager(requireContext(), 2)
